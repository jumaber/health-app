        ...
        <div className="relative border-l-2 border-blue-200 pl-6 space-y-10 ">
          ...
          <div>
            ...
            <p className="text-zinc-600">
              ...
              experiencing new <strong>food intolerances</strong>, particularly
              to dairy, gluten. These sensitivities worsened with time and
              became harder to manage after pregnancies.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-zinc-600">
              ...
              inflammation showed up gradually. This might’ve been the start of{" "}
              <strong>Hashimoto’s</strong>.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-zinc-600">
              ...
              intolerances, mood dips, and more. Strong cross-allergy reactions
              to Rosaceae family fruits started.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-zinc-600">
              <strong>Possible acquired mild Factor XIII deficiency</strong> due
              to excessive bleeding. Received every 5 months an iron infusion to
              compensate blood loss. Also completed a{" "}
          ...
          <div>
            <p className="text-zinc-800 font-bold">Feb 2025 — Eye Emergency</p>
          ...
          <div>
            ...
            <p className="text-green-700">
              Started <strong>Mirena IUD</strong> for long-term cycle regulation
              and hormone balance.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-zinc-600">
              Continuing daily medications (L-thyroxine, Chlormadinone), taking
              supplements, and living with food restrictions. I’m focused on
              light activity, managing stress, and slowly rebuilding my health.
            </p>
          </div>
        </div>
